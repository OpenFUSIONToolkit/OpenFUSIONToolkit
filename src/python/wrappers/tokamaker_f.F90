...
TYPE, BIND(C) :: tokamaker_settings_type
  ...
  REAL(KIND=c_double) :: ffp_target_weight = -1.d0 !< Weight for global targets when treated as soft constraints (negative for hard constraints)
  REAL(KIND=c_double) :: pp_target_weight = -1.d0 !< Weight for global targets when treated as soft constraints (negative for hard constraints)
