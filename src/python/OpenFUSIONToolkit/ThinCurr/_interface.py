...
# thincurr_set_thickness(tw_ptr,thickness_ptr,error_string)
thincurr_set_thickness = ctypes_subroutine(oftpy_lib.thincurr_set_thickness,
    [c_void_p, ctypes_numpy_array(float64,1), c_char_p])
...
# thincurr_time_domain_plot(tw_ptr,compute_B,rebuild_sensors,nsteps,nplot,sensor_ptr,sensor_vals_ptr,nsensor,compute_J_vol,hodlr_ptr,error_str)
thincurr_time_domain_plot = ctypes_subroutine(oftpy_lib.thincurr_time_domain_plot,
    [c_void_p, c_bool, c_bool, c_int, c_int, c_void_p, ctypes_numpy_array(float64,2), c_int, c_bool, c_void_p, c_char_p])
