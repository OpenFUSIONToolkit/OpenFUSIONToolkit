...
class HDF5(package):
    def __init__(self, parallel=False, cmake_build=False, build_deps=True):
        self.name = "HDF5"
...
if (options.hdf5_cc is not None) and (options.hdf5_fc is not None):
    ...
    packages.append(HDF5(parallel=(options.hdf5_parallel and use_mpi),cmake_build=options.hdf5_cmake_build,build_deps=options.hdf5_build_deps))
else:
    packages.append(HDF5(parallel=(options.hdf5_parallel and use_mpi),cmake_build=options.hdf5_cmake_build,build_deps=options.hdf5_build_deps))
