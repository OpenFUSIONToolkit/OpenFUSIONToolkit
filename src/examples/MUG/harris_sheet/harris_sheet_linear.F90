...
REAL(r8) :: n0 = 1.d0 !< Density scale factor
REAL(r8) :: velx0 = 1.d0 !< Velocity scale factor (x-direction)
REAL(r8) :: vely0 = 1.d0 !< Velocity scale factor (y-direction)
REAL(r8) :: velz0 = 1.d0 !< Velocity scale factor (z-direction)
REAL(r8) :: t0 = 1.d0 !< Temperature scale factor
REAL(r8) :: psi0 = 1.d0 !< Magnetic flux scale factor
REAL(r8) :: by0 = 1.d0 !< Magnetic field scale factor (y-direction)
REAL(r8) :: B_0(3) = 0.d0 !< Background magnetic field
...
REAL(r8) :: lam_n = 2.d0 !< Eq density scale length
REAL(r8) :: lam_b = 2.d0 !< Eq magnetic field scale length
REAL(r8) :: L_x = 2.d0 !< Pert wavelength in x
REAL(r8) :: L_z = 2.d0 !< Pert wavelength in z
...
IF (linear) THEN
  ...
  CALL mesh%save_vertex_scalar(vec_vals,mhd_sim%xdmf_plot,'psi_eq0')
ELSE
...
ELSE
  ...
  CALL v%restore_local(vec_vals,6)
