...
real(8) :: pt(3),psi_sol,curr_cent(2),Btor,Bpol(2),pani(2),bcross_kappa(1)
integer(4) :: i,m
...
tflux = 0.d0
bp_vol = 0.d0
!$omp parallel do private(m,goptmp,v,psitmp,gpsitmp,pt,psi_sol,itor_loc,Btor,Bpol,bcross_kappa,pani) &
