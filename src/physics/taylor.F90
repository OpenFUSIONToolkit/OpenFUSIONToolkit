...
ALLOCATE(taylor_hffa(taylor_nm,ML_oft_hcurl%nlevels))
ALLOCATE(taylor_hlam(taylor_nm,ML_oft_hcurl%nlevels))
ALLOCATE(taylor_htor(taylor_nm,ML_oft_hcurl%nlevels))
